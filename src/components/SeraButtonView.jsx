...
const GlowButton = ({
    ...
    return <button className="relative  rounded-2xl border-none p-0.5 transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95" style={{
...
export default function SeraButtonView() {
    return <div className="">
        <GlowButton variant="blue">Frontend Developer</GlowButton>
